...
public class FuFlags
{
    ...
    public void setSMTO_BLOCK(boolean b)
    {
        flags.set(0, b);
    } // 0x00000001
    
    public void setSMTO_ABORTIFHUNG(boolean b)
    {
        flags.set(1, b);
    } // 0x00000002
    
    public void setSMTO_NOTIMEOUTIFNOTHUNG(boolean b)
    {
        flags.set(3, b);
    } // 0x00000008
    
    public void setSMTO_ERRORONEXIT(boolean b)
    {
        flags.set(5, b);
    } // 0x00000020
    
    public void setSMTO_NORMAL()
    { // 0x00000000
        setSMTO_BLOCK(false);
