...
public class HexEditorEvent extends EventObject
{
    ...
    /**
     * Returns the number of bytes added. If this value equals the number of bytes removed, the bytes were actually modified.
     *
    ...
    /**
     * Returns the number of bytes removed. If this value equals the number of bytes added, then the bytes were actually modified.
     *
    ...
    /**
     * Returns whether this was a "modification" of bytes; that is, no bytes were added or removed, bytes were only modified. This is equivalent to <code>getAddedCount() == getRemovedCount()</code>.
     *
